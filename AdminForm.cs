...
namespace WinFormsApp
{
    public class AdminForm : Form
    {
        public AdminForm()
        {
            ...
            var canvas = UiFactory.CreateCanvas(this, Color.FromArgb(14, 28, 54), Color.FromArgb(8, 16, 28));

            UiFactory.CreateLabel(canvas, "ADMIN DASHBOARD", 38, 28, 11, FontStyle.Bold, Color.FromArgb(122, 223, 240));
            UiFactory.CreateLabel(canvas, "Quản trị báo cáo và cập nhật tin tức", 34, 58, 24, FontStyle.Bold, Color.White);
            UiFactory.CreateLabel(canvas, "Tổng quan dữ liệu ngày 19/04/2026", 38, 100, 10, FontStyle.Regular, Color.FromArgb(205, 218, 232));
            ...
            var reportCard = UiFactory.CreateCard(canvas, new Rectangle(38, 300, 560, 390), Color.FromArgb(8, 18, 38), Color.FromArgb(60, 122, 223, 240));
            UiFactory.CreateLabel(reportCard, "Báo cáo hiện trường", 22, 18, 14, FontStyle.Bold, Color.White);
            UiFactory.CreateLabel(reportCard, "Khu vực", 22, 58, 9.5f, FontStyle.Bold, Color.FromArgb(185, 210, 230));
            UiFactory.CreateLabel(reportCard, "Mức độ", 182, 58, 9.5f, FontStyle.Bold, Color.FromArgb(185, 210, 230));
            UiFactory.CreateLabel(reportCard, "Trạng thái", 302, 58, 9.5f, FontStyle.Bold, Color.FromArgb(185, 210, 230));
            UiFactory.CreateLabel(reportCard, "Thời gian", 432, 58, 9.5f, FontStyle.Bold, Color.FromArgb(185, 210, 230));
            ...
            UiFactory.CreateButton(reportCard, "Làm mới dữ liệu", new Rectangle(176, 336, 150, 38), Color.FromArgb(34, 51, 84), Color.White);

            var newsCard = UiFactory.CreateCard(canvas, new Rectangle(628, 300, 534, 390), Color.FromArgb(8, 18, 38), Color.FromArgb(60, 255, 111, 97));
            UiFactory.CreateLabel(newsCard, "Cập nhật tin tức", 22, 18, 14, FontStyle.Bold, Color.White);
            UiFactory.CreateLabel(newsCard, "Tiêu đề", 22, 58, 9.5f, FontStyle.Bold, Color.FromArgb(185, 210, 230));
            var titleBox = UiFactory.CreateTextBox(newsCard, new Rectangle(22, 80, 486, 34), "Cảnh báo giao thông khu vực trung tâm");
            UiFactory.CreateLabel(newsCard, "Nội dung", 22, 128, 9.5f, FontStyle.Bold, Color.FromArgb(185, 210, 230));
            var contentBox = UiFactory.CreateTextBox(newsCard, new Rectangle(22, 150, 486, 150),
                ...
                multiline: true);
            UiFactory.CreateLabel(newsCard, "Trạng thái đăng", 22, 316, 9.5f, FontStyle.Bold, Color.FromArgb(185, 210, 230));
        ...
        {
            var card = UiFactory.CreateCard(parent, bounds, Color.FromArgb(9, 22, 42), Color.FromArgb(70, accent));
            UiFactory.CreateLabel(card, title, 18, 18, 10, FontStyle.Bold, Color.FromArgb(186, 208, 230));
            UiFactory.CreateLabel(card, value, 18, 46, 24, FontStyle.Bold, accent);
            UiFactory.CreateLabel(card, description, 18, 84, 9.5f, FontStyle.Regular, Color.White);
        }
    }
}
